...
### 3. Токен центрифуги живет сутки. Необходимо обновлять его в этом интервале. Я обновлял его при каждой перезагрузке страницы, т.к не силен в клиентской части
## 6. Api методы
